                    ...
                    for (indexContext = contexts.scenario[typeScenario].length; indexContext--;) {
                        ...
                        for (indexField2 = 0; indexField2 < fields.length; indexField2++) {
                            ...
                            if (fieldName !== fields[indexField].name) {
                                //adiciona caso positivo para o caso negativo
                                //isso permite que se teste apenas um campo negativo
                                //e o resto do cenário seja positivo
...
module.exports = (function(config) {
    ...
    ****************************************************************/
    ...
    var randomLatLng = (function() {
        var lat = Math.floor((Math.random() * 1000)),
            lng = Math.floor((Math.random() * 1000)),
